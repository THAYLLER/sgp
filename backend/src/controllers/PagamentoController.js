...
module.exports = {
    ...
    async store(req, res){
        const {data,valor,periodo,carga_horaria_periodo,horas_em_sala,valor_total,curso,disciplina,profissional} = req.body;

        const retorno = pagamento.create({data,valor,periodo,carga_horaria_periodo,horas_em_sala,valor_total,curso,disciplina,profissional});
