...
routes.get('/disciplina/all', DisciplinaController.index);
routes.get('/disciplina/find/:id', DisciplinaController.show);
routes.post('/disciplina/new', DisciplinaController.store);
routes.put('/disciplina/edit/:id', DisciplinaController.update);
routes.delete('/disciplina/delete/:id', DisciplinaController.destroy);
